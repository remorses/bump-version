...
function createAnnotations({ githubToken, newVersion, linesReplaced = [], }) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const { data } = yield octokit.checks.create(Object.assign(Object.assign({}, github.context.repo), { name: github.context.action, head_sha: getSha(github.context), conclusion: 'success', output: {
