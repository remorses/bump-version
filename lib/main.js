...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (prefix) {
            ...
            const res = yield support_1.replacePattern(pattern, support_1.versionRegex, newVersion);
            linesReplaced = res.linesReplaced;
        }
        else {
            console.log(`replacing version patterns below [bump]`);
            const res = yield support_1.replacePattern(/\[bump\]/, support_1.versionRegex, newVersion);
            linesReplaced = res.linesReplaced;
        }
